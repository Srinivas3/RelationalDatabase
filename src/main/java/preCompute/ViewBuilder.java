...
public class ViewBuilder {
    ...
    private void addQueries() {
      ...
      /*
       ...
       queries.add("SELECT LINEITEM.SHIPMODE,LINEITEM.ORDERKEY FROM LINEITEM,ORDERS WHERE ORDERS.ORDERKEY = LINEITEM.ORDERKEY AND LINEITEM.SHIPDATE >= DATE('1992-01-01') AND LINEITEM.SHIPDATE < DATE('1992-12-31')");
        /*queries.add("SELECT LINEITEM.SHIPMODE,LINEITEM.COMMITDATE,LINEITEM.RECEIPTDATE,LINEITEM.ORDERKEY,LINEITEM.COMMITDATE,LINEITEM.EXTENDEDPRICE,LINEITEM.DISCOUNT,LINEITEM.QUANTITY FROM LINEITEM WHERE LINEITEM.SHIPDATE >= DATE('1993-01-01') AND LINEITEM.SHIPDATE <= DATE('1993-12-31')");
        queries.add("SELECT LINEITEM.SHIPMODE,LINEITEM.COMMITDATE,LINEITEM.RECEIPTDATE,LINEITEM.ORDERKEY,LINEITEM.COMMITDATE,LINEITEM.EXTENDEDPRICE,LINEITEM.DISCOUNT,LINEITEM.QUANTITY FROM LINEITEM WHERE LINEITEM.SHIPDATE >= DATE('1994-01-01') AND LINEITEM.SHIPDATE <= DATE('1994-12-31')");
        queries.add("SELECT LINEITEM.SHIPMODE,LINEITEM.COMMITDATE,LINEITEM.RECEIPTDATE,LINEITEM.ORDERKEY,LINEITEM.COMMITDATE,LINEITEM.EXTENDEDPRICE,LINEITEM.DISCOUNT,LINEITEM.QUANTITY FROM LINEITEM WHERE LINEITEM.SHIPDATE >= DATE('1995-01-01') AND LINEITEM.SHIPDATE <= DATE('1995-12-31')");
        queries.add("SELECT LINEITEM.SHIPMODE,LINEITEM.COMMITDATE,LINEITEM.RECEIPTDATE,LINEITEM.ORDERKEY,LINEITEM.COMMITDATE,LINEITEM.EXTENDEDPRICE,LINEITEM.DISCOUNT,LINEITEM.QUANTITY FROM LINEITEM WHERE LINEITEM.SHIPDATE >= DATE('1996-01-01') AND LINEITEM.SHIPDATE <= DATE('1996-12-31')");
        */
